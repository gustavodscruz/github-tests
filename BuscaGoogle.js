...
async function runTest() {
  ...
  try {
    ...
    await driver.findElement(By.name('q')).sendKeys('https://github.com/gustavodscruz', Key.RETURN);

    // Aguardar até que a página de resultados seja carregada
    await driver.wait(until.titleIs('https://github.com/gustavodscruz'), 15000);
    ...
    assert.ok(pageTitle.includes('https://github.com/gustavodscruz'), 'O título da página não contém a palavra "https://github.com/gustavodscruz".');
    testResults.assertions.push('Assertion 1: O título da página contém a palavra "https://github.com/gustavodscruz".');
    ...
    assert.ok(firstResultText.includes('https://github.com/gustavodscruz'), 'O primeiro resultado não contém a palavra "https://github.com/gustavodscruz".');
    testResults.assertions.push('Assertion 2: O primeiro resultado contém a palavra "https://github.com/gustavodscruz".');
